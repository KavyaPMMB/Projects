   ...
   <!--- <div class="blast-box">
    ...
    <div class="header-outs" id="header">
      <div class="header-w3layouts">
            ...
            <div class="col-lg-6 col-md-7 col-sm-9 info-contact-agile">
              <ul>
                ...
                <li>
                  ...
                  <p><a href="mailto:info@example.com">akcask@gmail.com</a></p>
                </li>
                <li>
                </li>
              </ul>
        ...
        <nav class="navbar navbar-expand-lg navbar-light">
          <div class="hedder-up">
            <h1 ><a href="index.php" class="navbar-brand" data-blast="color">College</a></h1>
          </div>
          ...
          <div class="headdser-nav-color" data-blast="bgColor">
            <div class="collapse navbar-collapse justify-content-end" id="navbarSupportedContent">
              <ul class="navbar-nav ">
				...
				<li class="nav-item">
                  <a href="#courses" class="nav-link scroll" >Courses</a>
                </li>
             <!--   <li class="nav-item">
              ...
              <div class="slider-img one-img">
                <div class="container">
                  <div class="slider-info text-center">
                    <h4 >WELCOME TO</h4>
                    <h5>Mary Matha Arts and Science College,Mananthavady</h5>
                    <p>We Believe There is Nothing More Important Than Education
                    </p>
                    <div class="outs_more-buttn" >
                      <a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="bgColor">LogIn/Register</a>
                    </div>
                  </div>
                </div>
              </div>
            ...
            <li>
              <div class="slider-img two-img">
                <div class="container">
                  <div class="slider-info text-center">
                    <h4>WELCOME  TO</h4>
                    <h5>Adityakiran College of Applied Studies</h5>
                    <p>The Future Of The World Is In My Class Room Today...
                    </p>
                    <div class="outs_more-buttn">
                      <a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="bgColor">LogIn/Register</a>
                    </div>
              ...
              <div class="slider-img three-img">
                <div class="container">
                  <div class="slider-info text-center">
                    <h4>WELCOME TO</h4>
                    <h5>Adityakiran College of Applied Studies</h5>
                    <p>When Educating The Minds Of Our Youth,We Must Not Forget To Educate Their Hearts...
                    </p>
                    <div class="outs_more-buttn">
                      <a href="#" data-toggle="modal" data-target="#exampleModalLive" data-blast="bgColor">LogIn/Register</a>
                    </div>
      ...
      <div class="container-fluid ">
        <div class="main row ">
         ...
         <div class="col-lg-4 view view-tenth">
            <img src="images/akcs1.jpg" alt="" class="img-fluid" style="border:#000000 solid 4px;box-shadow: 2px 2px 20px 0px #757575;">
            <!--<div class="mask">
          ...
          <div class="col-lg-4 view view-tenth">
            <img src="images/akcs2.jpg" alt="" class="img-fluid" style="border:#000000 solid 4px;box-shadow: 2px 2px 20px 0px #757575;">
            <!--<div class="mask">
          ...
          <div class="col-lg-4 view view-tenth">
            <img src="images/akcs3.jpg" alt="" class="img-fluid" style="border:#000000 solid 4px;box-shadow: 2px 2px 20px 0px #757575;">
          <!--  <div class="mask">
    ...
    <section class="about" id="about">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        ...
        <!--</h1> <ul class="resp-tabs-list justify-content-center">-->
		 <h3 class="title text-center mb-lg-12">About Us</h3><br><font color="#FF0066">Adityakiran College of Applied Studies, aprominent institution affliated to Kannur University and recoganized by Govt.of Kerala has been importing quality education since 2002 in the field of Commerce,Management,IT and Science to those Who aspire for higher education.Since 2009 the college is run by the Social Advancement and Development Agency for Knowledge Access(SADAKA)Trust.The College situates in its vast and own campus at Kuttur,Mathamangalam,12kms away from National Highway,Pilathara.It is equipped with convenient building,lab,library and other infrastrutures right as per University norms so as to impart quality education and research<br>We are innovative enough to adjust with the modern development and growth in the fields of education and knowledge.As a step in materializing the same,we impart special training for personality development,language proficiency and personal dexterities in student community so as to enable them to meet the needs of national and international globalized scenorio.Adityakiran College is very particular in maintaining the best educational atmosphere in the campus.All our programmes,policies and efforts aim at molding of a generation who profess social commitment and patriotism</font>
    ...
    <!--//about-->
    <!--service-->
    <section class="service py-lg-4 py-md-3 py-sm-3 py-3" id="courses">
      <div class="container py-lg-5 py-md-5 py-sm-4 py-3">
        <h3 class="title clr text-center mb-lg-5 mb-md-4  mb-sm-4 mb-3">courses</h3>
        <div class="row">
          <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
            <div class="white-shadow">
              ...
              <div class="ser-inner-info">
                <h4 class="my-3"><b>BCA</b></h4>
                <p>BCA is a new age degree course in the field of computer application</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
            <div class="white-shadow">
              ...
              <div class="ser-inner-info">
                <h4 class="my-3"><b>BBA</b><br>Retail Management</h4>
                <p>is 3 year proffessional degree course which train individuals in various aspect of retailing</p>
              </div>
            </div>
          </div>
          <div class="col-lg-4 col-md-6 col-sm-6 w3layouts-service-list text-center">
          ...
          <div class="col-md-5 address-grid">
            <div class="addres-office-hour text-center" >
              <ul>
                ...
                <li>
                  <p>Adityakiran College of Applied Studies<br>Krishnagiri,Kuttur</p>
                </li>
              </ul>
              <ul>
    ...
    <footer class="py-3">
      <div class="container">
        <div class="copy-agile-right text-center">
          ...
          <p>  © 2019 Adityakiran. All Rights Reserved | Design by <a href="http://www.W3Layouts.com" target="_blank">DS2K</a>
          </p>
      ...
      <div class="modal-dialog" role="document">
        <div class="modal-content">
          <div class="modal-header">
            <h4 class="modal-title" id="exampleModalLiveLabel" data-blast="color">Log In</h4>
...
?>
          ...
          <div class="modal-body">
		    User Type<select name="usertype" style="height:28px;width:195px;border-radius:20px;"><option value="1">Administrator</option><option value="2">Teacher</option><option value="3">Student</option><option value="4">Librarian</option><option value="5">Parent</option></select><br><br>
            Username<input type="text" name="username" style="border-radius:20px;"><br><br>
			Password<input type="password" name="password" style="border-radius:20px;"><br>
			<a href="register.php" style="color:#FF0066;text-decaration:none;">Create a new account,Sign Up</a>
