...
<form method="post">
<table>
<h1><font color="#FF0066">_____Issue Book_____</font></h1><hr /><br />
...
<br /><br />
<br /><hr />
<input type="submit" value="Issue" name="issue" style="color:#FFFFFF;background-color:#FF0066;height:40px;width:60;border-radius:20px;border:#000000 solid 2px;" />
</form>
</div>
</center>
</body>
...
$d=$_POST['author'];
$e=$_POST['date'];
$q="insert into book_issue(MemberId,BookId,BookName,Author,IssueDate)values('$a','$b','$c','$d','$e')";
$s="update book_entry set Availability='Unavailable' where BookId='$b'";
