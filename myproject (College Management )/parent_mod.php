...
<form method="post">
<input type="button" name="parent" value="parent" style="color:#FFFFFF;border:#000000 solid 1.5px;background-color:#FF0066;height:30px;width:70px;box-shadow:2px 1px 3px #666666;margin-top:8px;margin-left:1200px;"></a>
<a href="index.php">
...
<div class="sidenav">
  ...
  <a href="lib_view_members.php" target="iframe">View attendence</a>
  <a href="enter_books.php" target="iframe">view result</a>
